...
const headCells = [
  ...
  { id: "phone", numeric: false, disablePadding: false, label: "Telefonszám" },
  {
    id: "email_verified",
    numeric: false,
  ...
  const handleExport = () => {
    axios
      ...
      .then(function (response) {
        ...
        csvExporter.generateCsv(selectedUsers);
      })
...
function EnhancedTable() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoaded(false);
      try {
        const [users] = await axios.all([axios.get(API_URL + "/users")]);
        setData(users.data);
      } catch (error) {
        setError(error);
      }
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          {handleVerified(row.email_verified)}
                        </TableCell>
                        <TableCell align="left">
                          <IconButton
                            aria-label="edit"
